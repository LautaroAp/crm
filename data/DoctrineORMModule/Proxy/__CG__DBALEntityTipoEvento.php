 ...
 */
class TipoEvento extends \DBAL\Entity\TipoEvento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoEvento $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setId_tipoevento($id)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setId_tipoevento', [$id]);

        return parent::setId_tipoevento($id);
    }
